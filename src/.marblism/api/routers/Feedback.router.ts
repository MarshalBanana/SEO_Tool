...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.FeedbackInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).feedback.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.FeedbackInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).feedback.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.FeedbackInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).feedback.findFirst(input as any))),

        findMany: procedure.input($Schema.FeedbackInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).feedback.findMany(input as any))),
